...
module.exports = function(grunt) {
  ...
  <% if options.processor == 'less' %>
  grunt.registerTask('build:debug', ['clean', 'copy:prepare', 'requirejs:debug', 'less:debug', 'csso:debug']);
  grunt.registerTask('build:public', ['clean', 'copy:prepare', 'requirejs:public', 'less:public', 'csso:public', 'copy:finalize']);  
  <% else %>
